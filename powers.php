...
include("scripts/addToPowers.php");

$spells = $pdo->query('SELECT * FROM power');
?>
    ...
    <table id="grid-basic" class="table-responsive table-condensed table-hover table-striped">
		...
		<?if(isset($_SESSION["characterId"])){?>
			...
			<div class="form-group">
					PowerID: <input type="text" name="powerId" class = "form-control"><br>
			</div> 
					<input type="submit" name="submit">
			</form>
			<h2>enter the PowerID and press submit to add a spell to your selected character.</h2>

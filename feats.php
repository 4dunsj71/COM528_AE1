...
include("scripts/addToFeats.php");

$feats = $pdo->query('SELECT * FROM feat');
?>
...
<main role="main" class="container">
  ...
  <div class="starter-template">
    <h1>Dungeons and Dragons SPAGHETTI CODE SHITFEST</h1>
    ...
    <table id="grid-basic" class="table-responsive table-condensed table-hover table-striped">
        <thead>
						<tr>
							<?php
							// for each column
							for ($i = 0; $i < $feats->columnCount(); $i++) {
								// get the column name
								$name = $feats->getColumnMeta($i)['name'];
    ...
    <form action="feats.php" method="POST">
      <div class="form-group">
			  FeatID: <input type="text" name="featId" class = "form-control"><br>
      </div> 
			<input type="submit" name="submit">
		</form>
		<h2>enter the FeatID and press submit to add a spell to your selected character.</h2>
